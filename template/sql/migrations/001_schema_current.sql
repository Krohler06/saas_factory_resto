...
\restrict KodBk8BAR4oLGnHpNwCNEa60P9YCsbsrtkQHR08jaMdG2nrYmsVijQ4J6ackND6
...
--
-- Name: conversation_states conversation_states_unique_conversation; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.conversation_states
    ADD CONSTRAINT conversation_states_unique_conversation UNIQUE (restaurant_id, conversation_id, channel_type);
...
--
-- Name: IDX_workflow_publication_outbox_pending_workflow; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_conversation_states_conversation; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_conversation_states_conversation ON public.conversation_states USING btree (conversation_id);
...
--
-- Name: conversation_states conversation_states_restaurant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.conversation_states
    ADD CONSTRAINT conversation_states_restaurant_id_fkey FOREIGN KEY (restaurant_id) REFERENCES public.restaurants(id) ON DELETE CASCADE;
...
\unrestrict KodBk8BAR4oLGnHpNwCNEa60P9YCsbsrtkQHR08jaMdG2nrYmsVijQ4J6ackND6
